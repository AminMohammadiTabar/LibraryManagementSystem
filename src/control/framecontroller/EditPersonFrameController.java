...
public class EditPersonFrameController implements Initializable {
    @FXML
    Scene scene;
    @FXML
    private Stage stage;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        editBtn.setOnAction(event -> {
            String message="Are you sure to edit?";
            Alert alert=new Alert(Alert.AlertType.CONFIRMATION,message);
            alert.show();
            PersonController.edit(Integer.parseInt(idTxt.getText()),nameTxt.getText(),
                    lastNameTxt.getText(),membershipStartDatePicker.getValue());
            clearText();
        });
